...
#             yn = raw_input(Fore.WHITE + "Have you already installed /system/bin/adb via command line "+Fore.GREEN + "Y"+Fore.WHITE+"/"+Fore.RED+"N "+Fore.WHITE)
#             if yn == "n":
...
if os.path.isfile("/system/bin/adb"):
	ADb="/system/bin/adb"
elif os.path.isfile("/system/xbin/adb"):
	ADb="/system/xbin/adb"
elif os.path.isfile("/data/data/com.termux/files/usr/bin/adb"):
	ADb="/data/data/com.termux/files/usr/bin/adb";
elif os.path.isfile("/usr/bin/adb"):
	ADb="/usr/bin/adb"
...
def main():
    ...
    while(1):
        if option == '1':
            ...
            os.system(ADb+" kill-server && /system/bin/adb start-server")
            option = raw_input(Fore.WHITE + "phonesploit"+Fore.RED + "(main_menu) "+Fore.WHITE + "> ")
...
#=============================  
# Run
print (Fore.RED+"[!]"+Fore.WHITE+" Using "+ADb)
